'use client'
import { __PLACEHOLDER__ as iconsPackageReady } from '@qhuy/icons'
...
export default function PlaygroundPage() {
  ...
  return (
    <main>
      ...
      <section>
        <h2>Icons — package npm</h2>
        <p>
          <code>@qhuy/icons</code> résolu depuis npm :{' '}
          <strong>{iconsPackageReady ? 'ok' : 'non disponible'}</strong>
        </p>
      </section>
    </main>
  )
