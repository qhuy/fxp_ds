...
Avant review Bobun DS, chaque tenant doit fournir :
...
- [ ] Aucun CSS ciblant les classes internes Bobun DS.
...
Un tenant peut changer des valeurs de tokens. Il ne peut pas renommer ou supprimer des tokens publics sans coordination Bobun DS, car ces noms sont consommes par `@qhuy/react`.
