...
- **Theming multi-tenant via DTCG transforms (niveau 3)** — *tant que pas plusieurs tenants identifiés. Niveau 2 actuellement = light + dark via CSS vars. Upgrade niveau 3 plus tard sans rewrite (Style Dictionary supporte les deux).*
